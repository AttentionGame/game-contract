...
contract AttentionGame is ERC721Holder, ReentrancyGuard, Ownable, Pausable {
    ...
    /// @notice Computes the represented amount to be staked, based on NFT
    ...
    /// @param tokenIds The tokenIds of NFTs which will be staked
    function stake(uint256[] memory tokenIds) external nonReentrant whenNotPaused updateReward(msg.sender) {
        ...
        for (uint256 i = 0; i < tokenIds.length; i += 1) {
            ...
            // Change the consumer of the NFT to be the person who staked it
    ...
    /// @param tokenIds The tokenIds of NFT which will be withdrawn
